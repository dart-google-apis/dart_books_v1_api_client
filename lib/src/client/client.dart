...
abstract class Client extends ClientBase {
  ...
  BookshelvesResource_ get bookshelves => new BookshelvesResource_(this);
  CloudloadingResource_ get cloudloading => new CloudloadingResource_(this);
